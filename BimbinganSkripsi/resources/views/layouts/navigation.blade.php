<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('skripsi.index')" :active="request()->routeIs('skripsi.*')">
                        Skripsi Saya
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('akun_admin.index')" :active="request()->routeIs('akun_admin.*')">
                        Kelola Admin
                    </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user() && in_array(Auth::user()->role, ['mahasiswa', 'dosen']))
            <x-responsive-nav-link :href="route('skripsi.index')" :active="request()->routeIs('skripsi.*')">
                Skripsi Saya
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('akun_admin.index')" :active="request()->routeIs('akun_admin.*')">
                Kelola Admin
            </x-responsive-nav-link>
            @endif
        </div>
